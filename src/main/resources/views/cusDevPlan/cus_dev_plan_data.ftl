...
<html>
	<head>
		...
		<#include "../../../../../../../../JAVA学习/crm/crm09/src/main/resources/views/common.ftl">
	</head>
	...
	<#if saleChance.devResult==0 || saleChance.devResult==1>
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				...
				<a class="layui-btn  addNews_btn" lay-event="success">
					<i class="layui-icon">&#xe608;</i>
					开发成功
				</a>
				<a class="layui-btn layui-btn-danger addNews_btn" lay-event="failed">
					<i class="layui-icon">&#xe608;</i>
					开发失败
				</a>
			</div>
